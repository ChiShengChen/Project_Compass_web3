...
print(f'The contract has been deployed and the address is: {tx_receipt.contractAddress}') #old:  0xF6F82c740eb8A4a487a630e3882Af90F5B9F9cBB
...
signed_set_txn = w3.eth.account.sign_transaction(set_txn, private_key=private_key)
set_tx_hash = w3.eth.send_raw_transaction(signed_set_txn.raw_transaction)
w3.eth.wait_for_transaction_receipt(set_tx_hash)


data = contract.functions.get().call() #42
 # 0x63f91E53BfED6b73EaFC0b86F7Ec831bC891cF01
